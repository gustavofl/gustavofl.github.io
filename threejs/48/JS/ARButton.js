	...
	static createButton(renderer, sessionInit = {}) {
		...
		function showStartAR( /*device*/) {
			...
			if (sessionInit.domOverlay === undefined) {
				...
				const scaleMessageDiv = document.createElement('div');
				scaleMessageDiv.id = 'scale-message-div';
				scaleMessageDiv.style.position = 'absolute';
				scaleMessageDiv.style.left = '50%';
				scaleMessageDiv.style.transform = 'translateX(-50%)';
				scaleMessageDiv.style.top = '15%';
				scaleMessageDiv.style.padding = '1%';
				scaleMessageDiv.style.backgroundColor = 'rgba(220, 220, 220, 0.5)';
				scaleMessageDiv.style.borderRadius = '5px';
				scaleMessageDiv.style.textAlign = 'center';
				scaleMessageDiv.style.display = 'flex';
				scaleMessageDiv.style.alignItems = 'center';
				scaleMessageDiv.style.justifyContent = 'center';
				scaleMessageDiv.style.color = '#000';
				scaleMessageDiv.style.fontSize = '5vw';
				scaleMessageDiv.textContent = '100%';
				scaleMessageDiv.style.border = 'none';
				scaleMessageDiv.style.userSelect = 'none';
				scaleMessageDiv.style.webkitUserSelect = 'none'; // Safari/iOS
				scaleMessageDiv.style.transition = 'opacity 1s ease-out';
				scaleMessageDiv.display = 'none';

				// Adicionar o container ao overlay
				overlay.appendChild(scaleMessageDiv);

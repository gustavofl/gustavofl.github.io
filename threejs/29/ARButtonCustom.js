	...
	static createButton(renderer, sessionInit = {}) {
		...
		function showStartAR( /*device*/) {
			...
			if (sessionInit.domOverlay === undefined) {
				...
				promptsContainer.style.height = '150px';
				...
				botaoSetaEsquerda.style.fontSize = '2em';
				...
				botaoSetaDireita.style.fontSize = '2em';
				...
				tapPrompt.style.lineHeight = '75px'; // Centralizar verticalmente o texto

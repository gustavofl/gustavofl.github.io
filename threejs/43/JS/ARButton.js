	...
	static createButton(renderer, sessionInit = {}) {
		...
		function showStartAR( /*device*/) {
			...
			if (sessionInit.domOverlay === undefined) {
				...
				messageDiv.textContent = 'Clique na tela e arraste para posicionar o modelo';
				...
				botoesContainer.style.height = '40%';
				botoesContainer.style.width = '100%';
				botoesContainer.style.marginTop = '10px'; // Espaço entre o div e os botões

	...
	static createButton(renderer, sessionInit = {}) {
		...
		function showStartAR( /*device*/) {
			...
			if (sessionInit.domOverlay === undefined) {
				...
				tapPrompt.style.bottom = '50px';
				tapPrompt.style.transform = 'translateX(-50%)';
				tapPrompt.style.maxWidth = '90%';
				tapPrompt.style.backgroundColor = 'rgba(220, 220, 220, 0.5)';
				tapPrompt.style.padding = '10px';
				tapPrompt.style.borderRadius = '5px';
				tapPrompt.style.textAlign = 'center';
				tapPrompt.style.color = '#000';
				tapPrompt.style.fontSize = '1em';
				tapPrompt.textContent = 'Clique na tela para fixar/desafixar o notebook';
